...
В проекте разработана API для для CRUD операций над отверстиями в детали.
...
При изменении размера детали пропорционально изменяются координаты отверстий, принадлежащих детали. 

Валидация входных данных проверяет что размеры детали больше ноля и любая рассчитанная по паттерну координата отверстия не отрицательна. 
